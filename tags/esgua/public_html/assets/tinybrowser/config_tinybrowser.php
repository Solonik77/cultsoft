...
$sessionSavePath = realpath(dirname(__FILE__) . '/../../../app/runtime/sessions/') . '/';
...
$tinybrowser['sessioncheck'] = 'admin_authorized'; //name of session variable to check

// Random string used to secure Flash upload if session control not enabled - be sure to change!
$tinybrowser['obfuscate'] = 'sesd(bvvbgdherggfbb11';
...
$tinybrowser['path']['image'] = '/static/images/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = '/static/media/'; // Media files location
$tinybrowser['path']['file'] = '/static/'; // Other files location
...
$tinybrowser['tinymcecss'] = '/assets/tiny_mce/themes/advanced/skins/default/dialog.css';
