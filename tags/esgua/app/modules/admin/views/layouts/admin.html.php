...
<link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->request->getBaseUrl(true) ?>/css/admin/jquery.wysiwyg.css" media="screen" />
<link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->request->getBaseUrl(true) ?>/css/admin/tablesorter.css" media="screen" />
<link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->request->getBaseUrl(true) ?>/css/admin/thickbox.css" media="screen" />
...
<div id="header">
  ...
  <div id="header-status">
    <div class="container_12">
      <div class="grid_8"> <span id="text-invitation">Welcome back User X, you’ve got</span>
        <!-- Messages displayed through the thickbox -->
        <a href="messages4ca9.html?keepThis=true&amp;TB_iframe=true&amp;height=350&amp;width=565" title="Inbox" class="thickbox" id="message-notification"> <span>37</span> incoming messages. </a> </div>
      <div class="grid_4"> <a href="/site/logout" id="logout"> Logout </a> </div>
    </div>
...
<div class="container_12">
  <!-- Dashboard icons -->
  <div class="grid_7"> <a href="#" class="dashboard-module"> <img src="<?php echo Yii::app()->request->getBaseUrl(true) ?>/images/admin/Crystal_Clear_write.gif" width="64" height="64" alt="edit" /> <span>New article</span> </a> <a href="#" class="dashboard-module"> <img src="<?php echo Yii::app()->request->getBaseUrl(true) ?>/images/admin/Crystal_Clear_file.gif" width="64" height="64" alt="edit" /> <span>Upload file</span> </a> <a href="#" class="dashboard-module"> <img src="<?php echo Yii::app()->request->getBaseUrl(true) ?>/images/admin/Crystal_Clear_files.gif" width="64" height="64" alt="edit" /> <span>Articles</span> </a> <a href="#" class="dashboard-module"> <img src="<?php echo Yii::app()->request->getBaseUrl(true) ?>/images/admin/Crystal_Clear_calendar.gif" width="64" height="64" alt="edit" /> <span>Calendar</span> </a> <a href="#" class="dashboard-module"> <img src="<?php echo Yii::app()->request->getBaseUrl(true) ?>/images/admin/Crystal_Clear_user.gif" width="64" height="64" alt="edit" /> <span>My profile</span> </a> <a href="#" class="dashboard-module"> <img src="<?php echo Yii::app()->request->getBaseUrl(true) ?>/images/admin/Crystal_Clear_stats.gif" width="64" height="64" alt="edit" /> <span>Stats</span> </a> <a href="#" class="dashboard-module"> <img src="<?php echo Yii::app()->request->getBaseUrl(true) ?>/images/admin/Crystal_Clear_settings.gif" width="64" height="64" alt="edit" /> <span>Settings</span> </a>
    <div style="clear: both"></div>
  </div>
  <!-- End .grid_7 -->
  <!-- Account overview -->
  <div class="grid_5">
    <div class="module">
      ...
      <div class="module-body">
        <p> <strong>User: </strong>User X<br />
          <strong>Your last visit was on: </strong>20 January 2010,<br />
          <strong>From IP: </strong>000.000.00.00 </p>
        <div>
          <div class="indicator">
        ...
        <p> Need to switch to a bigger plan?<br />
  ...
  <div class="grid_12">
    <!-- Notification boxes -->
    <span class="notification n-success">Success notification.</span> <span class="notification n-information">Information notification.</span> <span class="notification n-attention">Attention notification.</span> <span class="notification n-error">Error notification.</span>
    <div class="bottom-spacing">
      <!-- Button -->
      <div class="float-right"> <a href="#" class="button"> <span>New Article <img src="<?php echo Yii::app()->request->getBaseUrl(true) ?>/images/admin/plus-small.gif" width="12" height="9" alt="New article" /></span> </a> </div>
    ...
    <div class="module">
      ...
      <div class="module-table-body">
            ...
            <tbody>
              <tr>
                ...
                <td><input type="checkbox" />
                  <a href="#"><img src="<?php echo Yii::app()->request->getBaseUrl(true) ?>/images/admin/tick-circle.gif" width="16" height="16" alt="published" /></a> <a href="#"><img src="<?php echo Yii::app()->request->getBaseUrl(true) ?>/images/admin/pencil.gif" width="16" height="16" alt="edit" /></a> <a href="#"><img src="<?php echo Yii::app()->request->getBaseUrl(true) ?>/images/admin/balloon.gif" width="16" height="16" alt="comments" /></a> <a href="#"><img src="<?php echo Yii::app()->request->getBaseUrl(true) ?>/images/admin/bin.gif" width="16" height="16" alt="delete" /></a> </td>
              </tr>
              <tr>
                ...
                <td>$6.95</td>
                <td><input type="checkbox" />
                  <a href="#"><img src="<?php echo Yii::app()->request->getBaseUrl(true) ?>/images/admin/minus-circle.gif" width="16" height="16" alt="not published" /></a> <a href="#"><img src="<?php echo Yii::app()->request->getBaseUrl(true) ?>/images/admin/pencil.gif" width="16" height="16" alt="edit" /></a> <a href="#"><img src="<?php echo Yii::app()->request->getBaseUrl(true) ?>/images/admin/balloon.gif" width="16" height="16" alt="comments" /></a> <a href="#"><img src="<?php echo Yii::app()->request->getBaseUrl(true) ?>/images/admin/bin.gif" width="16" height="16" alt="delete" /></a> </td>
              </tr>
              <tr>
        ...
        <div class="pager" id="pager">
          <form action="#">
            <div> <img class="first" src="<?php echo Yii::app()->request->getBaseUrl(true) ?>/images/admin/arrow-stop-180.gif" alt="first"/> <img class="prev" src="<?php echo Yii::app()->request->getBaseUrl(true) ?>/images/admin/arrow-180.gif" alt="prev"/>
              <input type="text" class="pagedisplay input-short align-center"/>
              <img class="next" src="<?php echo Yii::app()->request->getBaseUrl(true) ?>/images/admin/arrow.gif" alt="next"/> <img class="last" src="<?php echo Yii::app()->request->getBaseUrl(true) ?>/images/admin/arrow-stop.gif" alt="last"/>
    ...
    <!-- End .module -->
    <div class="pagination"> <a href="#" class="button"><span><img src="<?php echo Yii::app()->request->getBaseUrl(true) ?>/images/admin/arrow-stop-180-small.gif" height="9" width="12" alt="First" /> First</span></a> <a href="#" class="button"><span><img src="<?php echo Yii::app()->request->getBaseUrl(true) ?>/images/admin/arrow-180-small.gif" height="9" width="12" alt="Previous" /> Prev</span></a>
      <div class="numbers"> <span>Page:</span> <a href="#">1</a> <span>|</span> <a href="#">2</a> <span>|</span> <span class="current">3</span> <span>|</span> <a href="#">4</a> <span>|</span> <a href="#">5</a> <span>|</span> <a href="#">6</a> <span>|</span> <a href="#">7</a> <span>|</span> <span>...</span> <span>|</span> <a href="#">99</a> </div>
      <a href="#" class="button"><span>Next <img src="<?php echo Yii::app()->request->getBaseUrl(true) ?>/images/admin/arrow-000-small.gif" height="9" width="12" alt="Next" /></span></a> <a href="#" class="button last"><span>Last <img src="<?php echo Yii::app()->request->getBaseUrl(true) ?>/images/admin/arrow-stop-000-small.gif" height="9" width="12" alt="Last" /></span></a>
      <div style="clear: both;"></div>
    </div>
  </div>
  <!-- End .grid_12 -->
  ...
  <div class="grid_6">
    <div class="module">
      ...
      <div class="module-body"> <a href="#" class="removable">images</a><br />
  ...
  <div class="grid_6">
    <div class="module">
      ...
      <div class="module-body"> <a href="#" class="checkable">check articles for spelling</a><br />
        ...
        <form action="#">
          ...
          <input type="text" class="input-medium" />
          &nbsp;&nbsp;
          <input class="submit-green" type="submit" value="Add item" />
          </fieldset>
        </form>
      </div>
    </div>
  ...
  <div class="grid_12">
    <div class="module">
      ...
      <div class="module-body">
        <form action="#">
          <div> <span class="notification n-success">Success notification.</span> </div>
          <p>
            <label>Short textfield</label>
            <input type="text" class="input-short" />
            <span class="notification-input ni-correct">This is correct, thanks!</span> </p>
          <p>
            <label>Medium textfield</label>
            <input type="text" class="input-medium" />
            <span class="notification-input ni-error">Sorry, try again.</span> </p>
          <p>
          ...
          <ul>
            <li>
              <label>
              <input type="checkbox" name="a" checked="checked" id="cb1" />
              checkbox 1</label>
            </li>
            <li>
              <label>
  ...
  <div class="grid_6">
    <div class="module">
      ...
      <div class="module-body">
        <p class="notification n-attention"><strong>Running out of space?</strong><br />
          Just contact us and switch to a bigger plan</p>
        <div>
          <div class="indicator">
            <div style="width: 23%;">
              <!-- change the width value (23%) to dynamically control your indicator -->
