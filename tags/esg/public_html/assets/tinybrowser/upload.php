...
<head>
<title>TinyBrowser :: <?php echo TB_UPLOAD;
?></title>
...
?>"><?php echo TB_BROWSE;
?></a></span></li>
<li id="upload_tab" class="current"><span><a href="upload.php?type=<?php echo $typenow . $passfolder . $passfeid ;
?>"><?php echo TB_UPLOAD;
?></a></span></li>
<?php
...
<fieldset>
<legend><?php echo TB_UPLOADFILES;
?></legend>
<?php
