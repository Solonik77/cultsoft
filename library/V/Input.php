...
$this->user_agent = (! empty(
$_SERVER['HTTP_USER_AGENT']) ? trim(
$_SERVER['HTTP_USER_AGENT']) : '');
            if (v_utf8::strlen(
$this->user_agent) > 255) {
                
$this->user_agent = v_utf8::substr(
$this->user_agent,                   0,                   255);
            }
...
$_GET[
$this->clean_input_keys(
$key)] = 
$this->clean_input_data(
$val);
                }
            } else {
...
$ XSS clean the value
    * @return mixed
    */
    protected function search_array(
$array, 
$key,       
$default = null, 
$xss_clean = false)
...
$this->ip_address = substr(
$this->ip_address,               
$comma + 1);
        }
        if (! V_Helper_Valid::ip(
$this->ip_address)) {
            // Use an empty IP
...
$ data to clean
    * @param string 
$ xss_clean method to use ('htmlpurifier' or defaults to built-in method)
    * @return string
    */
...
$this,               'xss_filter_' . 
$tool)) {
            App::Log('Unable to use Input::xss_filter_' . 
$tool . '(), no such method exists',               Zend_Log::ERR);
...
$ data to clean
    * @return string
    */
    protected function xss_filter_default(
$data)
    {
...
$data = preg_replace('/(&#*\w+)[\x00-\x20]+;/u', '
$1;', 
$data);
        
$data = preg_replace('/(&#x*[0-9A-F]+);*/iu', '
$1;', 
$data);
...
$ data to clean
    * @return string
    */
    protected function xss_filter_htmlpurifier(
$data)
    {
        /**
        *
