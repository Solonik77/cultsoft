<?php
/**
* Upload helper class for working with the global 
$_FILES
...
class V_Helper_Upload {
    ...
    * @param mixed 
$ name of 
$_FILE input or array of upload data
    * @param string 
$ new filename
    * @param string 
$ new directory
...
$directory, '/') . '/';
        if (! is_dir(
$directory) and App::config()->upload->create_directories == true) {
...
$directory, 0777,               true);
        ...
        if (! is_writable(
$directory))
            throw new App_Exception('The upload destination folder, ' . 
$directory . ', does not appear to be writable.');
        if (is_uploaded_file(
$file['tmp_name']) and move_uploaded_file(
$file['tmp_name'],                   
$filename = 
$directory . 
$filename)) {
...
$extension];
        ...
        //return (! empty(
$extension) and in_array(
$extension, 
$allowed_types) and is_array(
$mime_types));
        return (! empty(
$extension) and in_array(
$extension, 
