...
$ a file path or file name
    * @param mixed 
$ data to be sent if the filename does not exist
    * @param string 
$ suggested filename to display in the download
    * @return void
    */
...
$mime = array('application/octet-stream');
        ...
        header('Content-Type: ' . 
$mime[0]);
        header('Content-Disposition: attachment; filename="' . (empty(
$nicename) ? 
$filename : 
$nicename) . '"');
        header('Content-Transfer-Encoding: binary');
        header('Content-Length: ' . sprintf('%d',               
$filesize));
