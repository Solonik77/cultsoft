...
$ end character or entity
    * @param boolean 
$ enable or disable the preservation of words while limiting
    * @return string
    */
...
$args))];
    ...
    *
    * @param string 
$ a type of pool, or a string of characters to use as the pool
    * @param integer 
...
$str[mt_rand(0,                   
$length - 1)] = chr(                   mt_rand(48,57));
            } elseif (ctype_digit(
$str)) {
                // Add a random letter
                
$str[mt_rand(0,                   
$length - 1)] = chr(                   mt_rand(65,90));
            }
        }
        return 
$str;
...
$ replacement string
    * @param boolean 
$ replace words across word boundries (space, period, etc)
    * @return string
    */
...
$badwords[
$key] = str_replace('\*', '\S*?',               preg_quote(                   (string) 
$badword));
        }
...
$text)
    {
        ...
        return text::auto_link_urls(           text::auto_link_emails(
$text));
    }
...
$text)
    {
        ...
        if (preg_match_all('~\b(?<!href="|">)(?:ht|f)tps?://\S+(?:/|\b)~i',               
$text, 
$matches)) {
            foreach(
$matches[0] as 
...
$text);
        ...
        if (preg_match_all('~\b(?<!://)www(?:\.[a-z0-9][-a-z0-9]*+)+\.[a-z]{2,6}\b~i',               
$text, 
$matches)) {
            foreach(
$matches[0] as 
...
$no_p = '(?:p|div|h[1-6r]|ul|ol|li|blockquote|d[dlt]|pre|t[dhr]|t(?:able|body|foot|head)|c(?:aption|olgroup)|form|s(?:elect|tyle)|a(?:ddress|rea)|ma(?:p|th))';
            // Put at least two linebreaks before and after 
$no_p elements
