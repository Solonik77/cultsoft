...
$email)
    {
        ...
        return (bool) checkdnsrr(           preg_replace('/^[^@]+@/', '', 
$email),           'MX');
    }
...
$utf8 = false)
    {
        return (
$utf8 === true) ? (bool) preg_match('/^\pL++
$/uD', (string) 
$str) : ctype_alpha(           (string) 
$str);
    }
...
$utf8 = false)
    {
        return (
$utf8 === true) ? (bool) preg_match('/^[\pL\pN]++
$/uD', (string) 
$str) : ctype_alnum(           (string) 
$str);
    }
...
$utf8 = false)
    {
        return (
$utf8 === true) ? (bool) preg_match('/^[-\pL\pN_]++
$/uD', (string) 
$str) : (bool) preg_match('/^[-a-z0-9_]++
$/iD', (string) 
$str);
    }
...
$utf8 = false)
    {
        return (
$utf8 === true) ? (bool) preg_match('/^\pN++
$/uD', (string) 
$str) : ctype_digit(           (string) 
$str);
    }
...
$str)
    {
        return (bool) preg_match('/^#?+[0-9a-f]{3}(?:[0-9a-f]{3})?
$/iD',           
$str);
    }
} // End valid
