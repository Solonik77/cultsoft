...
$ encode existing entities
    * @return string
    */
    public static function specialurlencode(
$str,       
$double_encode = true)
    {
        return str_replace(' ', '%20',           V_Helper_Html::specialchars(
$str,               
$double_encode));
    }
...
$protocol = null)
    {
        ...
        '<a href="' . V_Helper_Html::specialurlencode(           url::base(false, 
$protocol) . 
$file,           false) . '"' . // Attributes empty? Use an empty string
        (is_array(
$attributes) ? V_Helper_Html::attributes(
$attributes) : '') . '>' . // Title empty? Use the filename part of the URI
        ((
$title === null) ? end(               explode('/', 
$file)) : 
$title) . '</a>';
    }
...
$ link/title pairs
    * @return array
    */
    public static function anchor_array(array 
$array)
    {
...
$array[] = V_Helper_Html::anchor(// Complete URI for the URL
                implode('/', 
$segments) . '/' . 
$segment, // Title for the current segment
...
$array);
    ...
    *
    * @param string 
$ |array   tag name, or an array of tags
    * @param string 
$ tag "content" value
    * @return string
    */
...
$attr = in_array(           strtolower(
$tag),           Kohana::config('http.meta_equiv')) ? 'http-equiv' : 'name';
        return '<meta ' . 
$attr . '="' . 
$tag . '" content="' . 
$value . '" />';
    ...
    *
    * @param string 
$ |array  filename, or array of filenames to match to array of medias
    * @param string 
$ |array  media type of stylesheet, or array to match filenames
    * @param boolean 
...
$ |array  mimetype
    * @param string 
$ |array  specifies on what device the document will be displayed
    * @param boolean 
$ include the index_page in the link
    * @return string
    */
...
$script = url::base(                   (bool) 
$index) . 
$script;
            }
            
$compiled = '<script type="text/javascript" src="' . 
$script . '"></script>';
        }
        return 
$compiled . "\n";
...
$ image source, or an array of attributes
    * @param string 
$ |array  image alt attribute, or an array of attributes
    * @param boolean 
$ include the index_page in the link
    * @return string
    */
...
$compiled .= ' ' . 
$key . '="' . V_Helper_Html::specialchars(
$val) . '"';
        }
        return 
$compiled;
