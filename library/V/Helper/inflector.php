...
$str)
    {
        ...
        return isset(           V_Helper_Inflector::$uncountable[strtolower(
$str)]);
    }
...
$str . 
$count;
        if (isset(               V_Helper_Inflector::$cache[
$key]))
            return V_Helper_Inflector::$cache[
$key];
        if (V_Helper_Inflector::uncountable(
$str))
            return V_Helper_Inflector::$cache[
$key] = 
$str;
        ...
        if (
$irregular = array_search(
$str,               V_Helper_Inflector::$irregular)) {
            
$str = 
$irregular;
        } elseif (preg_match('/[sxz]es
$/', 
$str) or preg_match('/[^aeioudgkprt]hes
$/', 
$str)) {
            // Remove "es"
...
$str;
        ...
        if (isset(               V_Helper_Inflector::$irregular[
$str])) {
            
$str = V_Helper_Inflector::$irregular[
$str];
        } elseif (preg_match('/[sxz]
$/', 
$str) or preg_match('/[^aeioudgkprt]h
$/', 
$str)) {
            
$str .= 'es';
        } elseif (preg_match('/[^aeiou]y
$/', 
$str)) {
            // Change "y" to "ies"
...
$str = 'x' . strtolower(trim(
$str));
        
$str = ucwords(           preg_replace('/[\s_]+/', ' ', 
$str));
