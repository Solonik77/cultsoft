...
class Minify_Controller_Version1 extends Minify_Controller_Base
{
    ...
    public function setupSources ($options)
    {
        ...
        if (! isset($_GET['files']) || // verify at least one file, files are single comma separated, 
// and are all same extension
        ! preg_match('/^[^,]+\\.(css|js)(,[^,]+\\.\\1)*$/', $_GET['files'], $m) || // no "//" (makes URL rewriting easier)
strpos($_GET['files'], '//') !== false || // no "\"
strpos($_GET['files'], '\\') !== false || // no "./"
