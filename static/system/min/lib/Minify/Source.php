...
class Minify_Source
{
    ...
    public function __construct ($spec)
    {
        if (isset($spec['filepath'])) {
            ...
            $this->lastModified = filemtime($spec['filepath']) + // offset for Windows uploaders with out of sync clocks
round(Minify::$uploaderHoursBehind * 3600);
    ...
    {
        $exts = array('css' => Minify::TYPE_CSS , 'js' => Minify::TYPE_JS , 'html' => Minify::TYPE_HTML);
        foreach ($sources as $source) {
