...
$authAdapter = 
$this->_getAuthAdapter(
$formData['member_email'],
$formData['member_password']);
  
$result = App_Member::getAuth()->authenticate(
$authAdapter);
  if (! 
$result->isValid()) {
...
$this->view->form = 
$form;
  } else {App_Member::getAuth()->getStorage()->write(
$authAdapter->getResultRowObject(  array('id' , 'email')));if (isset(
$formData['remember_me'])) { Zend_Session::rememberMe(3600 * 24 * 14);}
