    ...
    for($i = 0; $i < $len; $i ++) {
        ...
        if ($mState == 0) {
            ...
            if (0 == (0x80 &$in)) {
                ...
                trigger_error('utf8::to_unicode: Illegal sequence identifier in UTF-8 at byte ' . $i,
                    E_USER_WARNING);
                return false;
            }
        } else {
            ...
            if (0x80 == (0xC0 &$in)) {
                ...
                trigger_error('utf8::to_unicode: Incomplete multi-octet sequence in UTF-8 at byte ' . $i,
                    E_USER_WARNING);
                return false;
            }
        }
