    ...
    */
    public static function auto_p($str, $br = true)
    {
        ...
        if ($html_found !== false) {
            ...
            $str = preg_replace('~<p>(?=</?' . $no_p . '[^>]*+>)~i',
                '', $str);
            $str = preg_replace('~(</?' . $no_p . '[^>]*+>)</p>~i',
                '$1', $str);
        }
