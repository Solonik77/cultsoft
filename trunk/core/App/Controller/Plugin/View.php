    ...
    */
        ...
        Zend_Controller_Request_Abstract $request)
    {
        try {
            ...
            $viewRenderer->setView($view)->setViewBasePathSpec($template_path)->setViewScriptPathSpec(
                ...
                (($backoffice_controller !== true) ? 'html/:module/:action.:suffix' : 'html/:action.:suffix'))->setViewSuffix('phtml');
            ...
            $view->getHelper('HeadMeta')->appendHttpEquiv('Content-Type',
            ...
            if ($backoffice_controller) {
                $view->getHelper('HeadMeta')->appendHttpEquiv('Designer',
