...
$from = array(App::config()->project->email , App::config()->project->title->
$requestLang);
}
if (is_string(
$from)) {
...
$e) {
App::log(__CLASS__ . ' error: Sending email from ' . 
$from . ' to ' . 
$to . ' failure. Mail body is: ' . 
$message . ' Reason: ' . 
 ...
 */
 public static function setDefaultTransport( array 
$config = array())
 {
  if (! isset(
$config['transport'])) {
...
$config['auth'], array('crammd5' , 'login' , 'plain'))) {
