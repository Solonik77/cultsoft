...
$_instances = array();
 protected 
$_defaultInstance = 'File';
 protected 
$_defaultFrontendOptions;
 protected 
...
$instanceId = 'getInstance' . ucfirst(strtolower(
$instanceId));
return App_Cache::$instance->
$instanceId();
  }
...
$systemCacheFrontend = 
$this->_defaultFrontendOptions;
// Permanent storage

$systemCacheFrontend['lifetime'] = null;

$this->initInstance(array('id' => 'System' , 
$systemCacheFrontend));
App_Cache::$instance = 
$this;
  }
...
$return = null;
  if ((strlen(
$method) > 11) and (substr(
$method, 0, 11) == 'getInstance')) {

$id = ucfirst(strtolower( substr(
$method, 11)));
if (! isset(
$this->cache->
$id)) {
...
$data = null;
  if (! (
$data = 
$this->cache->System->load('AclRoles'))) {
...
$data = null;
  if (! (
$data = 
$this->cache->System->load('SiteNavigationTree'))) {
 ...
 */
 public function initInstance(array 
$instanceId, 
...
$this->_defaultBackendOptions;
  if (is_array(
$instanceId) and isset(
$instanceId['id'])) {

$instanceId['id'] = ucfirst(strtolower(
$instanceId['id']));
...
$backend = (isset(
$instanceId['backend'])) ? ucfirst( strtolower(
$instanceId['backend'])) : 'File';
 
$this->cache->
$instanceId['id'] = Zend_Cache::factory('Core', 
$backend, 
$frontendOptions, 
$backendOptions);
