...
$translate = new Zend_Translate('csv', APPLICATION_PATH . 'i18n/', 
$system_lang,  array('scan' => Zend_Translate::LOCALE_FILENAME , 'disableNotices' => true));
  App::setTranslate(
$translate);
  setlocale(LC_ALL, 
$system_locales[
$system_lang] . '.' . App::config()->locale->charset);
