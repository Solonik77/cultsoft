...
class V_Helper_Valid {
    ...
    */
    ...
    {
        return (bool) preg_match('/^[-_a-z0-9\'+*$^&%=~!?{}]++(?:\.[-_a-z0-9\'+*$^&%=~!?{}]+)*+@(?:(?![-.])[-a-z0-9.]+(?<![-.])\.[a-z]{2,6}|\d{1,3}(?:\.\d{1,3}){3})(?::\d++)?$/iD',
            (string) $email);
    }
    ...
    */
    public static function email_rfc($email)
    {
        ...
        return (bool) preg_match('/^' . $addr_spec . '$/D',
            (string) $email);
    }
    ...
    */
    ...
    {
        return ($utf8 === true) ? (bool) preg_match('/^\pL++$/uD', (string) $str) : ctype_alpha(
            (string) $str);
    }
    ...
    */
    ...
    {
        return ($utf8 === true) ? (bool) preg_match('/^[\pL\pN]++$/uD', (string) $str) : ctype_alnum(
            (string) $str);
    }
    ...
    */
    ...
    {
        return ($utf8 === true) ? (bool) preg_match('/^\pN++$/uD', (string) $str) : ctype_digit(
            (string) $str);
    }
    ...
    */
    public static function numeric($str)
    {
        ...
        $locale = localeconv();
        return (bool) preg_match('/^-?[0-9' . $locale['decimal_point'] . ']++$/D',
            (string) $str);
    }
    ...
    */
    ...
    {
        return (bool) preg_match('/^#?+[0-9a-f]{3}(?:[0-9a-f]{3})?$/iD',
            $str);
    }
} // End valid
